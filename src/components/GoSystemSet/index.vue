...
const list = reactive<ListType[]>([
  {
    ...
    type: 'switch',
    name: 'Menu collapse',
    desc: 'When the home menu is collapsed, it is hidden from the interface'
  },
  {
    ...
    desc: 'Hidden when there is only a single item in the workspace form category'
  },
  {
    ...
    desc: 'Switch the language to reload the page',
    tip: 'If you fail to switch between languages in some regions, we recommend that you enable it'
  },
  {
    key: 'divider1',
    type: 'divider',
  ...
  },
  {
    ...
    desc: 'When you move the mouse in, you will be shown to switch to expand mode',
  },
  {
    ...
    desc: 'How the workspace toolbar is displayed',
    options: [
      {
        label: 'Sidebar',
  ...
  },
  {
    ...
    step: 1,
    suffix: 'px',
    desc: 'The workspace arrow keys control the distance traveled'
  },
  {
    ...
    step: 2,
    suffix: 'px',
    desc: 'The snapping distance when the workspace moves the chart'
  }
])
