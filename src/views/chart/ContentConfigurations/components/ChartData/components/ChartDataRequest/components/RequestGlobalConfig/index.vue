<template>
  ...
  <n-card class="n-card-shallow">
    <n-tag type="info" :bordered="false" style="border-radius: 5px"> Global public configuration </n-tag>
    <setting-item-box
      name="Service"
      :itemRightStyle="{
    ...
    >
      <!-- 源地址 -->
      <setting-item name="Front-loaded URL">
        <n-input
          v-model:value.trim="requestOriginUrl"
          :disabled="editDisabled"
          placeholder="Example：http://127.0.0.1/"
        ></n-input>
      </setting-item>
