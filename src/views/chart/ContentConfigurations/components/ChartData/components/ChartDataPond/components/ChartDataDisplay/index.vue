<template>
  <div class="go-chart-data-display">
    <n-scrollbar style="max-height: 570px">
      <div class="go-mr-3">
        <div>
          <setting-item-box name="Subject Information">
            <setting-item name="The name of the interface">
              <n-input size="small" :placeholder="targetData?.dataPondName || 'Not yet'" :disabled="true"> </n-input>
            </setting-item>
            <setting-item name="Interface type">
              <n-input size="small" :placeholder="requestHttpType || 'Not yet'" :disabled="true"></n-input>
            </setting-item>
          </setting-item-box>

          <setting-item-box>
            <setting-item name="Component spacing">
              <n-input size="small" :placeholder="`${requestInterval || 'Not yet'}`" :disabled="true">
                <template #suffix>
            ...
            <setting-item name="Global Interval (default)">
              <n-input size="small" :placeholder="`${globalData?.requestInterval || 'Not yet'}`" :disabled="true">
          ...
          <setting-item-box name="Source address" :alone="true">
            <n-input size="small" :placeholder="globalData?.requestOriginUrl || 'Not yet'" :disabled="true">
              <template #prefix>
          ...
          <setting-item-box name="Interface address" :alone="true">
            <n-input
              size="small"
              :placeholder="requestUrl || 'Not yet'"
              :disabled="true"
            >
              <template #prefix>
        ...
        <setting-item-box name="Type">
          <setting-item name="Configuration type">
            <n-input
              size="small"
          ...
          <div class="go-mt-3">
            ...
            <div v-else>
              ...
              <n-card class="go-mt-3 go-pb-3" v-if="requestParamsBodyType === RequestBodyEnum['NONE']">
                <n-text depth="3">This interface does not Body form</n-text>
              </n-card>
              ...
              <template v-else-if="requestParamsBodyType === RequestBodyEnum['JSON']">
                <n-card size="small" style="padding-bottom: 7px">
                  <n-code
                    :code="requestParams[RequestParamsTypeEnum.BODY][requestParamsBodyType] || 'No content yet'"
                    language="json"
                  ></n-code>
                </n-card>
              </template>
        ...
        <!-- SQL 请求 -->
        <div v-else>
          <setting-item-box name="Key name">
            <n-text>sql</n-text>
          </setting-item-box>
          <setting-item-box name="Key-value">
...
const requestContentTypeObj = {
  [RequestContentTypeEnum.DEFAULT]: 'Normal requests',
