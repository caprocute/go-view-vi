<template>
  <n-collapse-item title="Basic event configuration" name="2">
      ...
      <n-layout has-sider sider-placement="right">
        <n-layout style="height: 580px; padding-right: 20px">
          <n-tabs v-model:value="editTab" type="card" tab-style="min-width: 100px;">
            <!-- 提示 -->
            <template #suffix>
              <n-text class="tab-tip" type="warning">Tips: ECharts the component intercepts mouse events</n-text>
            </template>
            <n-tab-pane
      ...
      <template #action>
        <n-space justify="space-between">
          <div class="go-flex-items-center">
            ...
            <n-text class="go-ml-2" depth="2">It is written in the same way as normal JavaScript wording</n-text>
          </div>
...
const EventTypeName = {
  ...
  [BaseEvent.ON_MOUSE_ENTER]: 'Mouse in',
  [BaseEvent.ON_MOUSE_LEAVE]: 'Mouse out'
}
