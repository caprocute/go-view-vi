...
axiosInstance.interceptors.request.use(
    (config: InternalAxiosRequestConfig) => {
        ...
        console.log(`${import.meta.env.PROD ? import.meta.env.VITE_PRO_PATH : ''}${axiosPre}`)
...
axiosInstance.interceptors.response.use(
    ...
    (err: AxiosError) => {
        if (err.config && err.config.url && err.config.url.includes('demo-trafficid.vtscloud.vn')) {
